          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="group bg-white/80 backdrop-blur p-8 rounded-3xl shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-500 border border-gray-100 card-3d">
                ...
                <h3 className="text-xl font-bold text-[#2D3436] mb-4 text-center group-hover:text-[#FF7B54] transition-colors duration-300">Full-Screen Experience</h3>
                <p className="text-[#636E72] leading-relaxed text-center">{t('features.fullscreen')}</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-gray-800 dark:to-gray-700 p-6 rounded-xl">
                ...
                <h3 className="text-xl font-bold text-[#2D3436] mb-4 text-center group-hover:text-[#FF7B54] transition-colors duration-300">Smooth Animations</h3>
                <p className="text-[#636E72] leading-relaxed text-center">{t('features.animations')}</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-gray-800 dark:to-gray-700 p-6 rounded-xl">
                ...
                <h3 className="text-xl font-bold text-[#2D3436] mb-4 text-center group-hover:text-[#FF7B54] transition-colors duration-300">Rich Content</h3>
                <p className="text-[#636E72] leading-relaxed text-center">{t('features.content')}</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-gray-800 dark:to-gray-700 p-6 rounded-xl">
                ...
                <h3 className="text-xl font-bold text-[#2D3436] mb-4 text-center group-hover:text-[#FF7B54] transition-colors duration-300">AI-Generated Images</h3>
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-amber-50 dark:from-gray-800 dark:to-gray-700 p-6 rounded-xl">
                ...
                <h3 className="text-xl font-bold text-[#2D3436] mb-4 text-center group-hover:text-[#FF7B54] transition-colors duration-300">Integrated Audio</h3>
              ...
              <div className="bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-gray-800 dark:to-gray-700 p-6 rounded-xl">
                ...
                <h3 className="text-xl font-bold text-[#2D3436] mb-4 text-center group-hover:text-[#FF7B54] transition-colors duration-300">Error Reporting</h3>
                <p className="text-[#636E72] leading-relaxed text-center">{t('features.reporting')}</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {t.raw('design.items').map((item: string, index: number) => (
                <div key={index} className="group bg-white/80 backdrop-blur p-8 rounded-3xl shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-500 border border-gray-100 card-3d">
                  ...
                  <p className="text-[#636E72] leading-relaxed text-center">{item}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="mt-16 bg-white/80 backdrop-blur p-8 rounded-3xl shadow-xl border border-gray-100">
              <div className="flex items-center justify-center space-x-8">
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#FF7B54] to-orange-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                    </svg>
                  </div>
                  <div className="text-sm text-[#636E72]">Flashcard Study</div>
                </div>
                ...
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#9C27B0] to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                  </svg>
                </div>
                <div className="text-sm text-[#636E72]">Leitner System</div>
                </div>
                ...
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#4CAF50] to-green-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <div className="text-sm text-[#636E72]">Automated Scheduling</div>
                </div>
              </div>
            </div>
          </div>
