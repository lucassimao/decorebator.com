...
export const Logo: React.FC<IconProps> = ({ className }) => (
  <span className={`text-3xl font-bold text-blue-600 ${className}`}>Decorebator</span>
)
...
export const ListPlusIcon: React.FC<IconProps> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M8.25 6.75h7.5M8.25 12h7.5m-7.5 5.25h7.5M3.75 6.75h.007v.008H3.75V6.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM3.75 12h.007v.008H3.75V12zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM3.75 17.25h.007v.008H3.75v-.008zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM12 3.75v16.5M3.75 12h16.5m-16.5 5.25H12m6.75-5.25V3.75M12 3.75H3.75m16.5 0H12m6.75 5.25h-5.25M12 20.25h8.25A2.25 2.25 0 0022.5 18V6a2.25 2.25 0 00-2.25-2.25H3.75A2.25 2.25 0 001.5 6v12a2.25 2.25 0 002.25 2.25H12zM16.5 9.75v3m0 0v3m0-3h3m-3 0h-3"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M3.75 12h16.5m-16.5 5.25H12m6.75-5.25V3.75M12 3.75H3.75m16.5 0H12m6.75 5.25h-5.25M12 20.25h8.25A2.25 2.25 0 0022.5 18V6a2.25 2.25 0 00-2.25-2.25H3.75A2.25 2.25 0 001.5 6v12a2.25 2.25 0 002.25 2.25H12zM16.5 9.75v3m0 0v3m0-3h3m-3 0h-3"
    />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12h-15" />{' '}
    {/* Simplified version */}
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />{' '}
    {/* Another simplified version for plus */}
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M15 18.75v-3.75m0 0V11.25m0 3.75h3.75m-3.75 0H11.25"
    />{' '}
    {/* Plus sign */}
    <path
      strokeLinecap="round"
...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L1.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.25 7.5l.813 2.846a4.5 4.5 0 012.187 2.187L24.096 12l-2.846.813a4.5 4.5 0 01-2.187 2.187L18.25 19.5l-.813-2.846a4.5 4.5 0 01-2.187-2.187L12.404 12l2.846-.813a4.5 4.5 0 012.187-2.187L18.25 7.5z"
    />
  </svg>
)
