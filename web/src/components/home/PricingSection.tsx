  ...
  const plans = [
    {
      ...
      price: '$0',
      frequency: 'forever',
      features: ['1 Wordlist', 'Up to 10 Words', 'Basic Quiz Modes', 'Online Access Only'],
      cta: 'Start Free',
      bestValue: false,
    ...
    },
    {
      ...
      price: '$6.99',
      frequency: '/month',
      features: ['Unlimited Wordlists', 'Unlimited Words', 'All 7 Quiz Modes', 'Advanced Analytics', 'Offline Support', 'Priority Support'],
      cta: 'Start Monthly',
      bestValue: false,
    ...
    },
    {
      ...
      price: '$69.90',
      frequency: '/year',
      features: ['Everything in Monthly', 'Save $13.98 per year', 'Priority Customer Support', 'Early Access to Features'],
      cta: 'Start Annual',
      bestValue: true,
