...
const MetaTags: React.FC<MetaTagsProps> = ({
  ...
  return (
    <>
      ...
      <meta name="keywords" content="vocabulary learning, language learning, AI learning, spaced repetition, flashcards, quiz app, language app, multilingual, educational app" />
      ...
      <meta property="og:image:alt" content="Decorebator - AI-Powered Vocabulary Learning Platform" />
      ...
      <meta name="twitter:image:alt" content="Decorebator - AI-Powered Vocabulary Learning Platform" />
