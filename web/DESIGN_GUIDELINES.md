...
const NewSection: React.FC = () => {
  return (
    <section className="py-20 bg-white reveal"> {/* or bg-[#FDF6E3] for alternating */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold mb-4">
            Section Title with 
            <span className="bg-gradient-to-r from-[#FF7B54] to-[#FFD700] bg-clip-text text-transparent"> Highlighted Text</span>
          </h2>
