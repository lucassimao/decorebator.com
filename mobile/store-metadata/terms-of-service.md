# Terms of Service for Decorebator

**Last Updated: January 2025**

## 1. Agreement to Terms

By downloading, installing, or using the Decorebator mobile application ("App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.
...
- Content that violates guidelines will be automatically rejected
...
- Content status (approved, pending, rejected) is tracked and logged
...
**Version**: 1.0  
**Company**: Decorebator, LLC  
**Contact**: legal@decorebator.com