# App Store Categories and Metadata
...
- **Learning Outcomes**: Measurable vocabulary acquisition and retention
...
- **Multi-language Support**: Reference materials in 7+ languages
...
- No violence, adult themes, or inappropriate material
- Child-friendly learning environment with content filtering
...
4. **education** - App store category
5. **study** - User intent
...
9. **language study** - Broader category
...
- **Babbel**: Focus on vocabulary vs full language courses
...
- **pronunciation** - Audio learning support
...
- **Top 100** for primary keywords
- **Featured** by app stores for quality
...
- **Multi-language Support**: Content filtering in 8+ languages
- **Educational Standards**: Content evaluated for educational appropriateness
- **Family Safety**: Proactive protection against inappropriate material
...
- Regional language support quality
