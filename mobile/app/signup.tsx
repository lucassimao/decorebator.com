...
export default function SignupScreen() {
    ...
    const hasErrors = errors.email || errors.firstName || errors.lastName || errors.password
    ...
    return (
        <View style={{ ...styles.container }}>
            ...
            <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                    ...
                    <TextInput
                        ...
                        right={<TextInput.Icon icon="eye" onPress={toggleSecureTextEntry} />}
                        style={styles.inputs}
                        onBlur={onBlur}
                        onChangeText={onChange}
                ...
                name="password"
            />
            {hasErrors && <HelperText type="error">
            ...
            <Text style={{ ...styles.signInHelper }}>
                Already have an account? <Link replace style={{ color: theme.colors.primary }} href={'/signin'}>Sign in</Link>
            </Text>
