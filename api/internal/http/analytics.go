...
func RegisterAnalyticsRoutes(r *gin.RouterGroup, wordlistService *service.WordlistService, db *pgxpool.Pool) {
	analytics := r.Group("/analytics")

	analytics.GET("/wordlists/:id/stats", getWordlistStats(wordlistService, db))
	analytics.GET("/wordlists/:id/word-mastery", getWordlistWordMastery(wordlistService, db))
	analytics.GET("/wordlists/:id/learning-progress", getWordlistLearningProgress(wordlistService, db))
	analytics.GET("/wordlists/:id/practice-time", getWordlistPracticeTime(wordlistService, db))
	analytics.GET("/wordlists/:id/box-distribution-history", getWordlistBoxDistributionHistory(wordlistService, db))
	analytics.GET("/wordlists/:id/current-box-distribution", getWordlistCurrentBoxDistribution(wordlistService, db))
	analytics.GET("/wordlists/:id/quiz-type-performance", getWordlistQuizTypePerformance(wordlistService, db))
	analytics.GET("/progress-summary", getProgressSummary(db))
}
...
func getWordlistWordMastery(wordlistService *service.WordlistService, db *pgxpool.Pool) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		analyticsService, err := service.NewAnalyticsService(db, service.AnalyticsConfig{
			UserID:     userID,
...
func getWordlistLearningProgress(wordlistService *service.WordlistService, db *pgxpool.Pool) gin.HandlerFunc {
	return func(c *gin.Context) {
		wordlistID, err := strconv.ParseInt(c.Param("id"), 10, 64)
		if err != nil {
			c.JSON(http.StatusBadRequest, gin.H{"error": "Invalid wordlist ID"})
...
func getWordlistBoxDistributionHistory(wordlistService *service.WordlistService, db *pgxpool.Pool) gin.HandlerFunc {
	return func(c *gin.Context) {
		wordlistID, err := strconv.ParseInt(c.Param("id"), 10, 64)
		if err != nil {
			c.JSON(http.StatusBadRequest, gin.H{"error": "Invalid wordlist ID"})
...
func getWordlistQuizTypePerformance(wordlistService *service.WordlistService, db *pgxpool.Pool) gin.HandlerFunc {
	return func(c *gin.Context) {
		wordlistID, err := strconv.ParseInt(c.Param("id"), 10, 64)
		if err != nil {
			c.JSON(http.StatusBadRequest, gin.H{"error": "Invalid wordlist ID"})
...
func getWordlistCurrentBoxDistribution(wordlistService *service.WordlistService, db *pgxpool.Pool) gin.HandlerFunc {
	return func(c *gin.Context) {
		wordlistID, err := strconv.ParseInt(c.Param("id"), 10, 64)
		if err != nil {
			c.JSON(http.StatusBadRequest, gin.H{"error": "Invalid wordlist ID"})
...
func getWordlistPracticeTime(wordlistService *service.WordlistService, db *pgxpool.Pool) gin.HandlerFunc {
	return func(c *gin.Context) {
		wordlistID, err := strconv.ParseInt(c.Param("id"), 10, 64)
		if err != nil {
			c.JSON(http.StatusBadRequest, gin.H{"error": "Invalid wordlist ID"})
		...
		days := 7
		if d := c.Query("days"); d != "" {
			if parsed, parseErr := strconv.Atoi(d); parseErr == nil && parsed > 0 && parsed <= 30 {
				days = parsed
			}
		}
...
func getWordlistStats(wordlistService *service.WordlistService, db *pgxpool.Pool) gin.HandlerFunc {
	return func(c *gin.Context) {
		wordlistID, err := strconv.ParseInt(c.Param("id"), 10, 64)
		if err != nil {
			c.JSON(http.StatusBadRequest, gin.H{"error": "Invalid wordlist ID"})
