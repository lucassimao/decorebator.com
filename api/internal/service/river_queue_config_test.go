...
func TestWorkerQueueConfigCapsAndLegacyGating(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "IAP-only", legacyEnabled: false, wantTotal: 186, wantQueues: 11},
		{name: "legacy rollback surface", legacyEnabled: true, wantTotal: 196, wantQueues: 13},
	}
